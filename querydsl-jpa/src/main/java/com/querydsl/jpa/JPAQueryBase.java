 ...
 * @author tiwe
 */
public abstract class JPAQueryBase<T, Q extends JPAQueryBase<T, Q>> extends ProjectableQueryBase<T, Q> implements JPQLQuery<T> {
    ...
    public boolean exists() {
        return select(Expressions.ONE).firstResult() != null;
    }
